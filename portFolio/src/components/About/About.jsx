...
const About = () => {
  return (
    <div className="aboutContainer">
      <div className="about">
        <div className="profileDiv">
          {/* ADD this wrapper div for gradient ring */}
        ...
        <div className="aboutContent">
          ...
          <p>
            I am a Passionate Frontend Developer with 1+ years of experience and I also
            have experience as a full-stack developer, crafting innovative and user-friendly
            web solutions. I love working on projects that help me grow — and yes, coffee
            is my secret coding fuel!
          </p>
        </div>
      </div>
    </div>
